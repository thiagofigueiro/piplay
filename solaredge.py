...
# https://raw.githubusercontent.com/nmakel/solaredge_modbus/master/example_influxdb.py
# pip3 install influxdb solaredge_modbus
...
if __name__ == "__main__":
    ...
    while True:
        print("Connected:", inverter.connect())
        values = {}
        ...
        import pprint
        pprint.pprint(json_body, indent=2)
